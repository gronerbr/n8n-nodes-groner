...
import { editarContatoPorPropriedadeFields } from '../fields/EditarContatoPorPropriedade.fields';
import { NodeOperationError } from 'n8n-workflow';

export const editarContatoPorPropriedadeDescription = [
	...editarContatoPorPropriedadeFields,
];

export async function executeEditarContatoPorPropriedade(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
